...
- Do not commit database passwords, SSH keys, API tokens, SMTP credentials, production settings, or Drupal hash salts.
- Supply credentials through the target environment using the documented `AVNL_*` variables and protected server configuration.
