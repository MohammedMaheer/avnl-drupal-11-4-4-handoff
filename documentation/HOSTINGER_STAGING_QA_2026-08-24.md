...
- Drupal 11.4.4 and PHP 8.5.9 bootstrap successfully.
- Both Drupal and MariaDB containers are running; MariaDB reports healthy.
- All 360 database tables passed integrity checks with zero non-OK results.
...
- Composer metadata is valid. Exact Drupal 11.4.4 constraints produce expected schema-advice warnings only.
...
- Final database SHA-256: `d04d4dc914ac6409617bb1af130544c693c69a4a21663335ceb373367c409d6e`.
