...
The supplied Drupal 10.5.1 site has been upgraded to Drupal 11.4.4 on an isolated restore of the supplied database. Composer resolves successfully, Drupal bootstraps, database updates and cache rebuild complete, active configuration is exported, and no known Composer security advisories are reported.

## Major changes

- Core and dependency ecosystem upgraded to Drupal 11.4.4 / Symfony 7.4 / Twig 3.28; PHP requirement is >=8.3.
