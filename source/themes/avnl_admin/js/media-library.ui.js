/**
 * @file
 * Media Library overrides for avnl_admin
 */
(($, Drupal, window) => {
  /**
   ...
   */
  Drupal.behaviors.MediaLibraryItemSelectionavnl_admin = {
    attach() {
      ...
      if (!once('media-library-selection-info-avnl_admin-event', 'html').length) {
        return;
      }
      $(window).on(
        'dialog:aftercreate',
