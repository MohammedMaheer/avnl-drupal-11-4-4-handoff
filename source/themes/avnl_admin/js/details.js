/**
 * @file
 * avnl_admin's polyfill enhancements for HTML5 details.
 */
...
(($, Drupal) => {
   ...
   */
  Drupal.behaviors.avnl_adminDetails = {
    attach(context) {
      ...
      $(once('avnl_adminDetails', context === document ? 'html' : context)).on(
        'click',
        (event) => {
  ...
  Drupal.theme.detailsSummarizedContentWrapper = () =>
    `<span class="avnl_admin-details__summary-summary"></span>`;
