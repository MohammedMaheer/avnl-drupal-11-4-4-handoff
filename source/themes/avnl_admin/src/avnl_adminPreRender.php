...
namespace Drupal\avnl_admin;

use Drupal\Core\Render\Element;
use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the avnl_admin theme.
 *
 * @internal
 */
class avnl_adminPreRender implements TrustedCallbackInterface {
